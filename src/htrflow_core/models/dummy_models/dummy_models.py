...
# TODO combine both dummy models into one and add an argument to swith between bbox, masks and make a fixed bbox and mask to try to evaulate overlapping masks.
...
if __name__ == "__main__":
    from htrflow_core.image import create_blank
